...
exports.BooksModule = BooksModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Book', schema: books_schema_1.BookSchema }])],
        controllers: [books_controller_1.BooksController],
        providers: [books_repository_1.BooksRepository, books_service_1.BooksService],
    })
], BooksModule);
