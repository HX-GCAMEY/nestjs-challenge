...
exports.AuthorsModule = AuthorsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Author', schema: authors_schema_1.AuthorSchema }]),
        ],
        controllers: [authors_controller_1.AuthorsController],
        providers: [authors_repository_1.AuthorsRepository, authors_service_1.AuthorsService],
    })
], AuthorsModule);
